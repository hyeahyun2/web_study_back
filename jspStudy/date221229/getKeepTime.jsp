...
<body>
	...
	2) 세션이 마지막으로 접근한 시간을 가져오도록 session 내장 객체의 
		getLacstAccessedTime() 메서드 작성
	...
	// 세션이 마지막으로 접근한 시간
	long last_time = session.getLastAccessedTime(); // 단위 : 1/1000 초
	// 세션이 생성된 시간
	long start_time = session.getCreationTime(); // 단위 : 1/1000 초
