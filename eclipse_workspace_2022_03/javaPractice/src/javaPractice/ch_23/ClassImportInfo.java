 ...
 * Class 클래스를 가져올 수 있다면 해당 클래스의 정보, 
 * 즉 생성자, 메서드, 멤버 변수 정보를 찾을 수 있음.
 * 
 * 리플렉션 reflection : 클래스의 자료형을 모르는 상태에서 Class 클래스를 활용하여
 * 그 클래스의 정보를 가져오고, 이 정보를 활용하여 인스턴스를 생성하거나 메서드를 호출하는 방식.
 * 
 * 예제에서 사용하는 Constructor, Method, Field 등의 클래스는 
 * java.lang.reflect 패키지에 정의 되어 있음.
 * Class 클래스와 java.lang.reflect 패키지의 클래스를 사용하려면 리플랙션 프로그래밍이 가능.
 * */

public class ClassImportInfo {
	public static void main(String[] args) throws ClassNotFoundException {
		/* String 클래스의 정보 가져오기 */
//		Class strClass = Class.forName("java.lang.String"); // 클래스 이름으로
