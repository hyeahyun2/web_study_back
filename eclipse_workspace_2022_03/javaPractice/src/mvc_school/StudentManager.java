...
public class StudentManager {
	...
	public static void addClass() {
		...
		while(true) {
			...
			case 1:
				...
				break;
			case 2:
				setClass("수강포기 할 과목을 선택하세요", newStudent, true);
				break;
			case 3:
				return;
			}
	...
	public static void setScore() {
		...
		while(true) {
			...
			System.out.println("1. JAVA / 2. PYTHON / 3. C / 4. 종료");
			int classMenu = input.nextInt();
			...
			System.out.println(className[classMenu-1] +"성적 입력이 완료 되었습니다.");
		}
	}
	...
	static void One() {
		...
		printStudentInfo(newStudent); // 학생 정보 출력 메소드 실행
	}
	// 모든 학생 정보 출력
	static void All() {
		for(Student student : students) {
			printStudentInfo(student); // 학생 정보 출력 메소드 실행
			System.out.println();
		}
	}
}
